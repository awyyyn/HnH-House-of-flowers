...
import { ChevronRight, Flower, Heart } from "lucide-react";
								...
								<div className="flex flex-col justify-center space-y-4">
									<div className="space-y-2">
										...
										<p className="max-w-[600px] text-muted-foreground md:text-xl">
											Handcrafted bouquets delivered to your doorstep. Brighten
											someone's day with our beautiful arrangements.
										</p>
									</div>
							...
							<div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
								<div className="flex flex-col justify-center space-y-4">
									<div className="space-y-2">
										...
										<p className="max-w-[600px] text-muted-foreground md:text-xl">
											We're passionate about delivering fresh, beautiful flowers
								...
								{[
									{
										name: "Sarah Johnson",
										quote:
											"The flowers were absolutely stunning and lasted for weeks! The delivery was prompt and the arrangement was exactly as pictured. Will definitely order again.",
									},
									{
										name: "Michael Chen",
										quote:
											"I ordered flowers for my wife's birthday and she was thrilled. The quality and freshness were exceptional. Highly recommend!",
									},
									{
										name: "Emily Rodriguez",
										quote:
											"I've ordered from many florists before, but House of Flowers is by far the best. Their attention to detail and customer service is unmatched.",
									},
