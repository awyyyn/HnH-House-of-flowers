        ...
        >
          <g>
            <g>
              <path
                style={{ fill: "#E45D73" }}
                d="M398.231,142.224c0,78.545-63.68,142.218-142.231,142.218
                  c-78.545,0-142.221-63.673-142.221-142.218S177.455,0,256,0C334.551,0,398.231,63.68,398.231,142.224z"
              />
              <path
                style={{ fill: "#EC707F" }}
                d="M398.231,369.77C398.231,448.321,334.551,512,256,512c-78.545,0-142.221-63.679-142.221-142.23
                  c0-78.539,63.676-142.212,142.221-142.212C334.551,227.558,398.231,291.231,398.231,369.77z"
              />
              <path
                style={{ fill: "#E45D73" }}
                d="M142.221,113.77c78.548,0,142.221,63.673,142.221,142.224c0,78.545-63.673,142.224-142.221,142.224
                  C63.68,398.219,0,334.539,0,255.994C0,177.443,63.68,113.77,142.221,113.77z"
              />
              <path
                style={{ fill: "#EC707F" }}
                d="M369.769,113.77C448.32,113.77,512,177.443,512,255.994c0,78.545-63.68,142.224-142.231,142.224
                  c-78.538,0-142.211-63.68-142.211-142.224C227.558,177.443,291.231,113.77,369.769,113.77z"
              />
              <path
                style={{ fill: "#D5637B" }}
                d="M410.103,392.397c2.263-13.154,2.609-26.852,0.904-40.808
              ...
              <path
                style={{ fill: "#C85A71" }}
                d="M395.744,116.116c-8.378-1.551-17.064-2.353-25.949-2.353
              ...
              <path
                style={{ fill: "#C85A71" }}
                d="M116.15,116.225c-1.554,8.423-2.356,17.115-2.356,26c0,78.551,63.642,142.205,142.205,142.205
              ...
              <path
                style={{ fill: "#D5637B" }}
                d="M119.618,410.116c13.155,2.263,26.85,2.609,40.805,0.903
            ...
            <path
              style={{ fill: "#F3E39C" }}
              d="M329.622,256.007c0,40.654-32.968,73.616-73.622,73.616c-40.66,0-73.622-32.962-73.622-73.616
                c0-40.66,32.962-73.628,73.622-73.628C296.654,182.378,329.622,215.346,329.622,256.007z"
            />
            <path
              style={{ fill: "#E8D276" }}
              d="M303.673,199.962c10.942,12.847,17.577,29.475,17.577,47.68c0,40.654-32.962,73.615-73.615,73.615
